...
| Input device unavailable | `-32012 InputInjectionFailed` |
...
| Compositor IPC socket absent / query failed | `-32010 ProviderUnavailable` |
...
| Keyboard injection failed | `-32012 InputInjectionFailed` |
...
| Screencopy/portal denied or encode failed | `-32011 CaptureFailed` |
...
| No AT-SPI bus / assistive tech not enabled | `-32010 ProviderUnavailable` |
...
| Metacharacters (`;`, `|`, `&`, `` ` ``, `$()`, NUL) in args | `-32006 SanitizationRejected` |
